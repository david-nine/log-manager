...
import com.spynet.logmanager.domain.Company;
import com.spynet.logmanager.repository.CompanyRepository;
...
class CompanyResourceIT {
    ...
    private static final String DEFAULT_CNPJ = "8";
    private static final String UPDATED_CNPJ = "4935";

    private static final Boolean DEFAULT_REAL_TIME = false;
    private static final Boolean UPDATED_REAL_TIME = true;
    ...
    public static Company createEntity(EntityManager em) {
        Company company = new Company().name(DEFAULT_NAME).cnpj(DEFAULT_CNPJ).realTime(DEFAULT_REAL_TIME);
        return company;
    }
    ...
    public static Company createUpdatedEntity(EntityManager em) {
        Company company = new Company().name(UPDATED_NAME).cnpj(UPDATED_CNPJ).realTime(UPDATED_REAL_TIME);
        return company;
    }
    ...
    void createCompany() throws Exception {
        ...
        assertThat(testCompany.getRealTime()).isEqualTo(DEFAULT_REAL_TIME);
    }
    ...
    void getAllCompanies() throws Exception {
        ...
        restCompanyMockMvc
            ...
            .andExpect(jsonPath("$.[*].realTime").value(hasItem(DEFAULT_REAL_TIME.booleanValue())));
    }
    ...
    void getCompany() throws Exception {
        ...
        restCompanyMockMvc
            ...
            .andExpect(jsonPath("$.realTime").value(DEFAULT_REAL_TIME.booleanValue()));
    }
    ...
    void putExistingCompany() throws Exception {
        ...
        updatedCompany.name(UPDATED_NAME).cnpj(UPDATED_CNPJ).realTime(UPDATED_REAL_TIME);
        ...
        assertThat(testCompany.getRealTime()).isEqualTo(UPDATED_REAL_TIME);
    }
    ...
    void partialUpdateCompanyWithPatch() throws Exception {
        ...
        partialUpdatedCompany.realTime(UPDATED_REAL_TIME);
    ...
    void fullUpdateCompanyWithPatch() throws Exception {
        ...
        partialUpdatedCompany.name(UPDATED_NAME).cnpj(UPDATED_CNPJ).realTime(UPDATED_REAL_TIME);
