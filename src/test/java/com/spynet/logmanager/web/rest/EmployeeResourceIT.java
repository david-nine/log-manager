...
import com.spynet.logmanager.domain.Employee;
import com.spynet.logmanager.repository.EmployeeRepository;
...
class EmployeeResourceIT {
    ...
    private static final Long DEFAULT_WORKLOAD_MINUTES = 1L;
    private static final Long UPDATED_WORKLOAD_MINUTES = 2L;
    ...
    public static Employee createEntity(EntityManager em) {
        Employee employee = new Employee()
            ...
            .workloadMinutes(DEFAULT_WORKLOAD_MINUTES);
        return employee;
    }
    ...
    public static Employee createUpdatedEntity(EntityManager em) {
        Employee employee = new Employee()
            ...
            .workloadMinutes(UPDATED_WORKLOAD_MINUTES);
        return employee;
    }
    ...
    void createEmployee() throws Exception {
        ...
        assertThat(testEmployee.getRegistration()).isEqualTo(DEFAULT_REGISTRATION);
        assertThat(testEmployee.getHostname()).isEqualTo(DEFAULT_HOSTNAME);
        assertThat(testEmployee.getWorkloadMinutes()).isEqualTo(DEFAULT_WORKLOAD_MINUTES);
    }
    ...
    @Test
    @Transactional
    void checkRegistrationIsRequired() throws Exception {
        int databaseSizeBeforeTest = employeeRepository.findAll().size();
        // set the field null
        employee.setRegistration(null);
    ...
    void getAllEmployees() throws Exception {
        ...
        restEmployeeMockMvc
            ...
            .andExpect(jsonPath("$.[*].workloadMinutes").value(hasItem(DEFAULT_WORKLOAD_MINUTES.intValue())));
    }
    ...
    void getEmployee() throws Exception {
        ...
        restEmployeeMockMvc
            ...
            .andExpect(jsonPath("$.workloadMinutes").value(DEFAULT_WORKLOAD_MINUTES.intValue()));
    }
    ...
    void putExistingEmployee() throws Exception {
        ...
        assertThat(testEmployee.getRegistration()).isEqualTo(UPDATED_REGISTRATION);
        assertThat(testEmployee.getHostname()).isEqualTo(UPDATED_HOSTNAME);
        assertThat(testEmployee.getWorkloadMinutes()).isEqualTo(UPDATED_WORKLOAD_MINUTES);
    }
    ...
    void partialUpdateEmployeeWithPatch() throws Exception {
        ...
        partialUpdatedEmployee.registration(UPDATED_REGISTRATION).hostname(UPDATED_HOSTNAME);
