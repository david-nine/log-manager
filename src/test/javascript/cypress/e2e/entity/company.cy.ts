...
describe('Company e2e test', () => {
  ...
  const companySample = { name: 'Dollar Madeira' };
  ...
  describe('new Company page', () => {
    ...
    it('should create an instance of Company', () => {
      cy.get(`[data-cy="name"]`).type('distributed Ferramentas').should('have.value', 'distributed Ferramentas');

      cy.get(`[data-cy="realTime"]`).should('not.be.checked');
      cy.get(`[data-cy="realTime"]`).click().should('be.checked');
