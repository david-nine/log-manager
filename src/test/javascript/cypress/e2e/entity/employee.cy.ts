...
describe('Employee e2e test', () => {
  ...
  const employeeSample = { name: 'Federal Producer envisioneer', registration: 'Kip', hostname: 'verde-azulado' };
  ...
  describe('new Employee page', () => {
    ...
    it('should create an instance of Employee', () => {
      ...
      cy.get(`[data-cy="registration"]`).type('transform').should('have.value', 'transform');

      cy.get(`[data-cy="hostname"]`).type('back-end reboot XML').should('have.value', 'back-end reboot XML');

      cy.get(`[data-cy="workloadMinutes"]`).type('84341').should('have.value', '84341');
