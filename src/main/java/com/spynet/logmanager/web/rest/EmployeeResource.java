...
/**
 * REST controller for managing {@link com.spynet.logmanager.domain.Employee}.
 */
@RestController
@RequestMapping("/api")
@Transactional
        ...
        Optional<Employee> result = employeeRepository
            ...
            .map(existingEmployee -> {
                ...
                if (employee.getRegistration() != null) {
                    existingEmployee.setRegistration(employee.getRegistration());
                }
                if (employee.getHostname() != null) {
                    existingEmployee.setHostname(employee.getHostname());
                }
                if (employee.getWorkloadMinutes() != null) {
                    existingEmployee.setWorkloadMinutes(employee.getWorkloadMinutes());
                }
