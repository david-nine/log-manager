package com.spynet.logmanager.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.spynet.logmanager.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.spynet.logmanager.repository.UserRepository.USERS_BY_EMAIL_CACHE);
