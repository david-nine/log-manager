...
describe('Manager Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'manager', component: ManagerComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to managerService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getManagerIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getManagerIdentifier).toHaveBeenCalledWith(entity);
